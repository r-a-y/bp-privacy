...
/**
 * Groups Privacy Settings Screen
 */
...
add_action( 'bp_authz_add_settings_nav', 'bp_authz_add_groups_nav' );


function bp_authz_screen_groups_privacy() {
...
function bp_authz_screen_groups_privacy_content() {
	global $bp, $current_user, $bp_privacy_updated; ?>

	<h3><?php _e( 'Set the rights to who can see your groups', BP_AUTHZ_PLUGIN_NAME ) ?></h3>
